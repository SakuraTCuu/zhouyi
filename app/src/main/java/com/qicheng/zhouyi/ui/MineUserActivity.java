...
//            sendStudentInfoToServer(file);
    ...
    private void showImage(String imaePath) {
        ...
        //传到服务器
        OkHttpManager.request(Constants.getApi.UPDATEUSERICON, RequestType.POST, map, new OkHttpManager.RequestListener() {
            @Override
            public void Success(HttpInfo info) {
    ...
    private void sendStudentInfoToServer(File file) {
        ...
        if (file != null && file.exists()) {
            ...
            OkHttpManager.sendMultipart(Constants.getApi.UPDATEUSERICON, builder.build(), new Callback() {
                @Override
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    Log.e("onResponse--->>", "onResponse: 成功上传图片之后服务器的返回数据：" + result);
