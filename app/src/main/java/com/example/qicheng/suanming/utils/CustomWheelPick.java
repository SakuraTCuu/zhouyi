...
/**
 * Created by Sakura on 2020-04-18 10:20
 */
public abstract class CustomWheelPick extends LinearLayout
    ...
    public CustomWheelPick(Context context) {
        super(context);
        init(context);
    }

    public CustomWheelPick(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
