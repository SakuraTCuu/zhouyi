...
/**
 * Created by Sakura on 2020-04-20 11:47
 */
...
public class GlnlUtils {
     ...
     * @author liu 2015-1-5
     */
    public static glnlType lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception {
        ...
        String nlDate = formatter.format(myDate);

//        int nlYear = Integer.parseInt(nlDate.substring(0, 4));
//        int nlMonth = Integer.parseInt(nlDate.substring(4, 6));
//        int nlDay = Integer.parseInt(nlDate.substring(6, 8));
        String result = nlDate.substring(0, 4) + "-" + nlDate.substring(4, 6) + "-" + nlDate.substring(6, 8);
        glnlType nl = new glnlType(nlDate.substring(0, 4), nlDate.substring(4, 6), nlDate.substring(6, 8), result);
        return nl;
    }

//    public static String getGlDate(String lunarDate, boolean leapMonthFlag) throws Exception {
//        glnlType nlType = GlnlUtils.lunarToSolar(lunarDate, leapMonthFlag);
//        return dateStr;
//    }

    public static class glnlType {
        public String year;
        public String month;
        public String day;
        public String all;

        public glnlType(String year, String month, String day, String all) {
            this.year = year;
            this.month = month;
            this.day = day;
            this.all = all;
